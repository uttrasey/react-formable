...
const codeTextFiles = {
    ...
    clear: require('fs').readFileSync(__dirname + '/subsections/clear/code.js', 'utf8')
};

const codeComponents = {
    basic: require('./subsections/basic/code'),
    signup: require('./subsections/signup/code'),
    clear: require('./subsections/clear/code')
};
...
export const markdown = {
    ...
    clear: require('fs').readFileSync(__dirname + '/subsections/clear/description.md', 'utf8')
};
